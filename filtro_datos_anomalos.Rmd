...
#NAME
```{r}
HQ<-(CORRELACION_NORTE_SUR_Vol_VI)
```
...
#HQ_CAMBIANTE
#MAGNESIO
HQ_Mg<-HQ_IONES[HQ_IONES$MASCARA_PARAMETRO=="MAGNESIO",c(1,25)]
#HQ_Mg
#CALCIO
HQ_Ca<-HQ_IONES[HQ_IONES$MASCARA_PARAMETRO=="CALCIO",c(1,25)]
#HQ_Ca
#SODIO
HQ_Na<-HQ_IONES[HQ_IONES$MASCARA_PARAMETRO=="SODIO",c(1,25)]
#HQ_Na
#POTASIO
HQ_K<-HQ_IONES[HQ_IONES$MASCARA_PARAMETRO=="POTASIO",c(1,25)]
#HQ_K
#BICARBONATO
HQ_HCOtres<-HQ_IONES[HQ_IONES$MASCARA_PARAMETRO=="BICARBONATO",c(1,25)]
#HQ_HCOtres
#CLORURO
HQ_Cl<-HQ_IONES[HQ_IONES$MASCARA_PARAMETRO=="CLORURO",c(1,25)]
#HQ_Cl
#SULFATO
HQ_SOcuatro<-HQ_IONES[HQ_IONES$MASCARA_PARAMETRO=="SULFATO",c(1,25)]
#HQ_SOcuatro
#NITRATO
HQ_NOtres<-HQ_IONES[HQ_IONES$MASCARA_PARAMETRO=="NITRATO",c(1,25)]
#HQ_NOtres
#NITRITO
HQ_NOdos<-HQ_IONES[HQ_IONES$MASCARA_PARAMETRO=="NITRITO",c(1,25)]
#HQ_NOdos
#HIERRO
HQ_Fe<-HQ_IONES[HQ_IONES$MASCARA_PARAMETRO=="HIERRO",c(1,25)]
#HQ_Fe
#pH
...
HQ_complemento<-HQ[,c("ID_MUESTRA","UG_Superficial","Edad_Superficial","Norte_Sur_Cimitarra")]
...
#EXPORTAR ARCHIVO
```{r}
write.csv(MEQ_20_MAY,"MEQ_20_MAY_v5.csv")
write.csv(MEQ,"MEQ_v3.csv")
